...
export const TutorialOverlay: React.FC<TutorialOverlayProps> = ({ isOpen, onComplete, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/85 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="bg-white dark:bg-dark-surface rounded-2xl w-full max-w-[500px] p-8 md:p-10 shadow-2xl relative flex flex-col items-center text-center animate-in zoom-in-95 duration-300 border border-gray-100 dark:border-dark-border">
        ...
        {currentStep === 2 && (
          <div className="w-full animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            <div className="bg-gray-50 dark:bg-dark-bg p-5 rounded-xl mb-8 text-left border border-gray-100 dark:border-dark-border">
        ...
        {currentStep === 3 && (
          <div className="w-full animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            <div className="mb-8 relative mx-auto w-full max-w-[280px] tutorial-card-demo">
              <div 
        ...
        {currentStep === 4 && (
          <div className="w-full animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            <div className="bg-orange-50 dark:bg-orange-900/20 border-l-4 border-orange-500 p-4 rounded-r-lg mb-4 text-left">
        ...
        {currentStep === 5 && (
          <div className="w-full animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            <button 
              onClick={handleNext} // Calls onComplete
              className="w-full bg-primary hover:bg-primary-hover text-white font-bold py-3.5 rounded-xl shadow-lg shadow-primary/20 transition-all active:scale-[0.98]"
            >
              Start Learning! 🚀
            </button>
